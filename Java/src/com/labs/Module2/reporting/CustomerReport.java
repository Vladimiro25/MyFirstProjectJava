package com.labs.Module2.reporting;
    ...
    public void generateReport() {
        ...
        for (int cust_idx = 0; cust_idx < bank.getNumOfClients(); cust_idx++) {
            ...
            for (int acct_idx = 0; acct_idx < customer.getNumOfAccounts();acct_idx++) {
                ...
                //применили форматированный вывод с помощью DecimalFormat
                ...
                System.out.println("    " + account_type + ": current balance is " + amountFormat.format(account.getBalance())+account_params);
            }
        }
    }
}
